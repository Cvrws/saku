    ...
    public final Listener<Render2DEvent> onRender2D = event -> {		
        for (EntityPlayer player : mc.world.playerEntities) {
            ...
            if (!box.is("None")) {
            	...
            	RenderUtil.drawSimpleBackground(player, Color.BLACK);
            	RenderUtil.drawSimpleBox(player, this.getTheme().getAccentColor(first), this.getTheme().getAccentColor(second));
