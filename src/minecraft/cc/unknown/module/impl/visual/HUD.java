...
public final class HUD extends Module {
	...
	private final ModeValue colorMode = new ModeValue("ArrayList Style Color", this)
    ...
    private final ModeValue themeMode = new ModeValue("Theme", this)
            .add(new SubMode("Aubergine"))
            .add(new SubMode("Aqua"))
            .add(new SubMode("Banana"))
            .add(new SubMode("Blend"))
            .add(new SubMode("Blossom"))
            .add(new SubMode("Bubblegum"))
            .add(new SubMode("Candy Cane"))
            .add(new SubMode("Cherry"))
            .add(new SubMode("Christmas"))
            .add(new SubMode("Coral"))
            .add(new SubMode("Digital Horizon"))
            .add(new SubMode("Express"))
            .add(new SubMode("Lime Water"))
            .add(new SubMode("Lush"))
            .add(new SubMode("Halogen"))
            .add(new SubMode("Hyper"))
            .add(new SubMode("Magic"))
            .add(new SubMode("May"))
            .add(new SubMode("Orange Juice"))
            .add(new SubMode("Pastel"))
            .add(new SubMode("Pumpkin"))
            .add(new SubMode("Satin"))
            .add(new SubMode("Snowy Sky"))
            .add(new SubMode("Steel Fade"))
            .add(new SubMode("Sundae"))
            .add(new SubMode("Sunkist"))
            .add(new SubMode("Water"))
            .add(new SubMode("Legacy"))
            .add(new SubMode("Winter"))
            .add(new SubMode("Peony"))
            .add(new SubMode("Shadow"))
            .add(new SubMode("Wood"))
            .add(new SubMode("Creida"))
            .add(new SubMode("Creida Two"))
            .add(new SubMode("Gothic"))
            .add(new SubMode("Rue"))
