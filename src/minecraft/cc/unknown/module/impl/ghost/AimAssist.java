...
public final class AimAssist extends Module {
    ...
    private float getYaw(@NotNull Vec3 pos) {
    ...
    private float getPitch(@NotNull Vec3 pos) {
        return getPitch(mc.player, pos);
    }
    ...
    private float rotMove(double target, double current, double diff, Double gcd) {
        float delta;
