...
public final class ConfigScreen implements Screen, Accessor {
    ...
    public final TextBox searchBar = new TextBox(new Vector2d(200, 200), Fonts.ROBOTO.get(20, Weight.LIGHT), Color.WHITE, TextAlign.CENTER, "Start typing to search...", 150);
