...
public class BoundsNumberValueComponent extends ValueComponent {
    ...
    public final TextBox valueDisplay = new TextBox(new Vector2d(0, 0), Fonts.MAISON.get(16, Weight.NONE), Colors.SECONDARY_TEXT.get(), TextAlign.LEFT, (((BoundsNumberValue) value).getDefaultValue()).toString().replace(".0", "") + " " + (((BoundsNumberValue) value).getDefaultSecondValue()).toString().replace(".0", ""), 100, "1234567890. ");
