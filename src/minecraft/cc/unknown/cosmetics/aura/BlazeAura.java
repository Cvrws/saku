...
public class BlazeAura extends CosmeticBase {
	...
	private static final ResourceLocation blazeTextures = new ResourceLocation("sakura/cosmes/blaze.png");
	...
	public void render(AbstractClientPlayer player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		if (CosmeticController.shouldRenderCosmeticForPlayer(player, CosmeticType.BLAZE) && player == mc.player && !player.isInvisible()) {
			GlStateManager.pushMatrix();
			playerRenderer.bindTexture(blazeTextures);
