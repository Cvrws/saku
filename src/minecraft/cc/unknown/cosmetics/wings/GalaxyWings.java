...
public class GalaxyWings extends ModelBase implements LayerRenderer<AbstractClientPlayer> {
	...
	public GalaxyWings(RenderPlayer playerRendererIn) {
		...
		this.location = new ResourceLocation("sakura/cosmes/gwings1.png");
	...
	public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scalee) {
		if (entitylivingbaseIn == mc.player && !entitylivingbaseIn.isInvisible() && CosmeticController.shouldRenderCosmeticForPlayer(entitylivingbaseIn, CosmeticType.GALAXY)) {
