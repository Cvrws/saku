...
public class Tophat extends CosmeticBase {
	...
	private static final ResourceLocation texture = new ResourceLocation("sakura/cosmes/hat.png");
	...
	public void render(AbstractClientPlayer player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float headYaw, float headPitch, float scale) {
		if (CosmeticController.shouldRenderCosmeticForPlayer(player, CosmeticType.TOP) && player == mc.player && !player.isInvisible()) {
