package cc.unknown.cosmetics.cape;
...
public class Cape implements LayerRenderer<AbstractClientPlayer>, Accessor {	
	...
	public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		...
		if (entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE) && entitylivingbaseIn == mc.player) {
	        ...
	        if (capeType != null && capeType != CapeType.NONE) {
	        	renderPlayer.bindTexture(new ResourceLocation(capeType.getPath()));
	        }
	        
	        if (capeType == CapeType.NONE) {
	        	renderPlayer.bindTexture(new ResourceLocation(null));
	        }
