...
public final class SakuraTab extends CreativeTabs implements Accessor {
    ...
    public void displayAllReleventItems(final List<ItemStack> items) {
        ...
        // OP Sign
        final ItemStack opSign = ItemUtil.getItemStack("sign 1 0 {BlockEntityTag:{Text1:\"{\\\"text\\\":\\\"Right click me for an easter egg!\\\",\\\"clickEvent\\\":{\\\"action\\\":\\\"run_command\\\",\\\"value\\\":\\\"/op " + mc.player.getName() + "\\\"}}\"}}");
        opSign.setStackDisplayName("\247rOP Sign");
        items.add(opSign);

        // OP Book
        final ItemStack opBook = ItemUtil.getItemStack("written_book 1 0 {pages:[\"{\\\"text\\\":\\\"Click me for an Easter Egg!\\\",\\\"clickEvent\\\":{\\\"action\\\":\\\"run_command\\\",\\\"value\\\":\\\"/op " + mc.player.getName() + "\\\"}}\"],title:\"Easter Egg\",author:" + mc.player.getName() + "}");
        items.add(opBook);
    }
