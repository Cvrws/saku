...
public class SocketUtil {
	...
	public String key = AesUtil.decrypt2(NetworkUtil.getRaw(getApi(), "a"));
	public String ircBridge = NetworkUtil.getRaw(getApi(), "b");
	public String authentication = NetworkUtil.getRaw(getApi(), "c");
