...
public class PacketAPI extends API {
    ...
    public void sendUseEntity(final int entityID, final String action) {
        PacketUtil.send(new C02PacketUseEntity(Minecraft.getInstance().world.getEntityByID(entityID),
    ...
    public void sendEntityAction(int entityID, String action) {
        PacketUtil.send(new C0BPacketEntityAction(Minecraft.getInstance().world.getEntityByID(entityID),
