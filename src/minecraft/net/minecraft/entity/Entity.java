...
public abstract class Entity implements ICommandSender {
    ...
    protected transient BlockPos lastPortalPos;
    protected transient Vec3 lastPortalVec;
...
//        this.speeds.add(Math.sqrt((this.prevPosX - this.posX) * (this.prevPosX - this.posX) + (this.prevPosZ - this.posZ) * (this.prevPosZ - this.posZ)));
    ...
    public void setPortal(BlockPos p_181015_1_) {
        if (this.timeUntilPortal > 0) {
            ...
            if (!this.worldObj.isRemote && !p_181015_1_.equals(this.lastPortalPos)) {
                this.lastPortalPos = p_181015_1_;
