...
public class DataWatcher {
    ...
    public byte getWatchableObjectByte(final int id) {
        return ((Byte) this.getWatchedObject(id).getWatchedObject()).byteValue();
    }

    public short getWatchableObjectShort(final int id) {
        return ((Short) this.getWatchedObject(id).getWatchedObject()).shortValue();
    }
    ...
    public int getWatchableObjectInt(final int id) {
        return ((Integer) this.getWatchedObject(id).getWatchedObject()).intValue();
    }

    public float getWatchableObjectFloat(final int id) {
        return ((Float) this.getWatchedObject(id).getWatchedObject()).floatValue();
    }
    ...
    public Rotations getWatchableObjectRotations(final int id) {
        return (Rotations) this.getWatchedObject(id).getWatchedObject();
    }
    ...
    private static void writeWatchableObjectToPacketBuffer(final PacketBuffer buffer, final DataWatcher.WatchableObject object) throws IOException {
        ...
        switch (object.getObjectType()) {
            case 0:
                buffer.writeByte(((Byte) object.getWatchedObject()).byteValue());
                break;

            case 1:
                buffer.writeShort(((Short) object.getWatchedObject()).shortValue());
                break;

            case 2:
                buffer.writeInt(((Integer) object.getWatchedObject()).intValue());
                break;

            case 3:
                buffer.writeFloat(((Float) object.getWatchedObject()).floatValue());
                break;
            ...
            case 5:
                final ItemStack itemstack = (ItemStack) object.getWatchedObject();
                buffer.writeItemStackToBuffer(itemstack);
                break;

            case 6:
                final BlockPos blockpos = (BlockPos) object.getWatchedObject();
            ...
            case 7:
                final Rotations rotations = (Rotations) object.getWatchedObject();
