...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
	...
	public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
		...
		entityplayer.ticksSinceTeleport = 0;
	...
	public void handleSetSlot(S2FPacketSetSlot packetIn) {
		...
		if (packetIn.func_149175_c() == -1) {
			...
			if (packetIn.func_149175_c() == 0 && packetIn.slotID() >= 36 && packetIn.slotID() < 45) {
				ItemStack itemstack = entityplayer.inventoryContainer.getSlot(packetIn.slotID()).getStack();

				if (packetIn.stack() != null
						&& (itemstack == null || itemstack.stackSize < packetIn.stack().stackSize)) {
					packetIn.stack().animationsToGo = 5;
				}

				try {

					packetIn.stack().realStackSize = entityplayer.inventory.mainInventory[packetIn.slotID()
							- 36].realStackSize;
	...
	public void handleUpdateSign(S33PacketUpdateSign packetIn) {
		...
		if (!flag && this.gameController.player != null) {
			this.gameController.player.addChatMessage(new ChatComponentText("Unable to locate sign at "
	...
	public void handleTeams(S3EPacketTeams packetIn) {
		...
		if (packetIn.getAction() == 0 || packetIn.getAction() == 2) {
			...
			scoreplayerteam.setChatFormat(ChatFormatting.func_175744_a(packetIn.getColor()));
