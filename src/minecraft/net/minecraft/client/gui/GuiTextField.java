    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                j1 = this.fontRendererInstance.drawWithShadow(s1, (float)l, (float)i1, i);
            }
            ...
            {
                j1 = this.fontRendererInstance.drawWithShadow(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                ...
                {
                    this.fontRendererInstance.drawWithShadow("_", (float)k1, (float)i1, i);
                }
            }
