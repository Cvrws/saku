    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (this.recordPlayingUpFor > 0)
        {
            ...
            if (l1 > 8)
            {
                ...
                this.getFontRenderer().draw(this.recordPlaying, -this.getFontRenderer().width(this.recordPlaying) / 2, -4, l + (l1 << 24 & -16777216));
                GlStateManager.disableBlend();
        ...
        if (this.titlesTimer > 0)
        {
            ...
            if (i2 > 8)
            {
                ...
                this.getFontRenderer().draw(this.displayedTitle, (float)(-this.getFontRenderer().width(this.displayedTitle) / 2), -10.0F, 16777215 | j2, true);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(2.0F, 2.0F, 2.0F);
                this.getFontRenderer().draw(this.displayedSubTitle, (float)(-this.getFontRenderer().width(this.displayedSubTitle) / 2), 5.0F, 16777215 | j2, true);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        for (Score score1 : collection)
        {
            ...
            if (j == collection.size())
            {
                ...
                this.getFontRenderer().draw(s3, l1 + i / 2 - this.getFontRenderer().width(s3) / 2, k - this.getFontRenderer().FONT_HEIGHT, 553648127);
            }
        }
    }
