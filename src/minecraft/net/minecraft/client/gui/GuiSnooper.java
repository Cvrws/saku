...
public class GuiSnooper extends GuiScreen
{
    ...
    class List extends GuiSlot
    {
        ...
        {
            GuiSnooper.this.fontRendererObj.draw((String)GuiSnooper.this.field_146604_g.get(entryID), 10, p_180791_3_, 16777215);
            GuiSnooper.this.fontRendererObj.draw((String)GuiSnooper.this.field_146609_h.get(entryID), 230, p_180791_3_, 16777215);
        }
