        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            if (ingestservertester != null)
            {
                ...
                else if (entryID < ingestservertester.func_153028_p())
                {
                    ...
                    {
                        s1 = ChatFormatting.RED + "Down!";
                    }
                }
                else
                {
                    s1 = ChatFormatting.OBFUSCATED + "1234" + ChatFormatting.RESET + " kbps";
                }
            }
            ...
            {
                s2 = ChatFormatting.BLUE + "(Preferred)";
            }
            else if (ingestserver.defaultServer)
            {
                s2 = ChatFormatting.GREEN + "(Default)";
            }
            ...
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s1, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.width(s1), p_180791_3_ + 5, 8421504);

            if (s2 != null)
            {
                GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s2, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.width(s2), p_180791_3_ + 5 + 3 + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT, 8421504);
            }
        }
