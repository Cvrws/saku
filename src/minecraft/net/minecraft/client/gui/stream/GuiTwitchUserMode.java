...
{
    private static final ChatFormatting field_152331_a = ChatFormatting.DARK_GREEN;
    private static final ChatFormatting field_152335_f = ChatFormatting.RED;
    private static final ChatFormatting field_152336_g = ChatFormatting.DARK_PURPLE;
    ...
    public void initGui()
    {
        ...
        {
            k = Math.max(k, this.fontRendererObj.width(ichatcomponent.getFormattedText()));
        }
