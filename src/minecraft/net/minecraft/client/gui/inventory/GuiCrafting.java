...
public class GuiCrafting extends GuiContainer
{
    ...
    {
        this.fontRendererObj.draw(I18n.format("container.crafting", new Object[0]), 28, 6, 4210752);
        this.fontRendererObj.draw(I18n.format("container.inventory", new Object[0]), 8, this.ySize - 96 + 2, 4210752);
    }
