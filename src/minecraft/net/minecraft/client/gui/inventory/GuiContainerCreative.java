...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if (creativetabs.drawInForegroundOfTab())
        {
            ...
            this.fontRendererObj.draw(I18n.format(creativetabs.getTranslatedTabLabel(), new Object[0]), 8, 6, 4210752);
        }
    }
    ...
    protected void renderToolTip(ItemStack stack, int x, int y)
    {
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex())
        {
            ...
            {
                list.add(1, "" + ChatFormatting.BOLD + ChatFormatting.BLUE + I18n.format(creativetabs.getTranslatedTabLabel(), new Object[0]));
            }
