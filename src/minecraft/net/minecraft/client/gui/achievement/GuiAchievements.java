...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    protected void drawTitle()
    {
        int i = (this.width - this.field_146555_f) / 2;
        int j = (this.height - this.field_146557_g) / 2;
        this.fontRendererObj.draw(I18n.format("gui.achievements", new Object[0]), i + 15, j + 5, 4210752);
    }
    ...
    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_)
    {
        ...
        if (achievement != null)
        {
            ...
            {
                int j8 = Math.max(this.fontRendererObj.width(s), 120);
                ...
                if (this.statFileWriter.hasAchievementUnlocked(achievement))
                {
                    this.fontRendererObj.drawWithShadow(I18n.format("achievement.taken", new Object[0]), (float)i7, (float)(k7 + i9 + 4), -7302913);
                }
            }
            else if (i8 == 3)
            {
                s = I18n.format("achievement.unknown", new Object[0]);
                int k8 = Math.max(this.fontRendererObj.width(s), 120);
            ...
            {
                int l8 = Math.max(this.fontRendererObj.width(s), 120);
