...
public class RenderManager {
	...
	public void cacheActiveRenderInfo(final World worldIn, final FontRenderer textRendererIn,
			final Entity livingPlayerIn, final Entity pointedEntityIn, final GameSettings optionsIn,
		...
		if (livingPlayerIn instanceof EntityLivingBase && ((EntityLivingBase) livingPlayerIn).isPlayerSleeping()) {
			...
			if (Reflector.callBoolean(block, Reflector.ForgeBlock_isBed, iblockstate, worldIn,
					new BlockPos(livingPlayerIn), livingPlayerIn)) {
				final EnumFacing enumfacing = (EnumFacing) Reflector.call(block, Reflector.ForgeBlock_getBedDirection,
	...
	public boolean shouldRender(final Entity entityIn, final ICamera camera, final double camX, final double camY,
			final double camZ) {
	...
	public boolean renderEntityWithPosYaw(final Entity entityIn, final double x, final double y, final double z,
	 ...
	 */
	private void renderDebugBoundingBox(final Entity entityIn, final double p_85094_2_, final double p_85094_4_,
		...
		final AxisAlignedBB axisalignedbb1 = new AxisAlignedBB(axisalignedbb.minX - entityIn.posX + p_85094_2_,
		...
		worldrenderer.pos(p_85094_2_, p_85094_4_ + (double) entityIn.getEyeHeight(), p_85094_6_)
				.func_181669_b(0, 0, 255, 255).endVertex();
