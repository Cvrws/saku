...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.fontRendererObj, ChatFormatting.GRAY + (ChatFormatting.BOLD + "Version Information"), (width - this.fontRendererObj.width("Version Information")) / 2, fixedHeight, -1);
    ...
    class SlotList extends GuiSlot {
        ...
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int i5) {
            drawCenteredString(mc.fontRendererObj,(ViaLoadingBase.getInstance().getTargetVersion().getIndex() == i ? ChatFormatting.GREEN.toString() + ChatFormatting.BOLD : ChatFormatting.GRAY.toString()) + ViaLoadingBase.getProtocols().get(i).getName(), width / 2, i2 + 2, -1);
            GlStateManager.pushMatrix();
